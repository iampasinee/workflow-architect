...
export const initialStudents: Student[] = [
  {
    ...
    year: 3,
    facultyId: 'fac_001', departmentId: 'dep_001', programId: 'prog_001',
    program: 'Information and Network Engineering', programCode: 'INET',
    classGroupId: 'group_001', classGroup: 'INET-DE-RA', yearLevel: 3,
  ...
  },
  {
    ...
    year: 2,
    facultyId: 'fac_002', departmentId: 'dep_003', programId: 'prog_004',
    program: 'Computer Science', programCode: 'CS',
    classGroupId: 'group_008', classGroup: 'CS-DE-2A', yearLevel: 2,
  ...
  },
  {
    ...
    facultyId: 'fac_001', departmentId: 'dep_001', programId: 'prog_001',
    program: 'Information and Network Engineering', programCode: 'INET',
    classGroupId: 'group_003', classGroup: 'INET-DE-Y1', yearLevel: 1,
  ...
  },
  {
    ...
    facultyId: 'fac_001', departmentId: 'dep_001', programId: 'prog_001',
    program: 'Information and Network Engineering', programCode: 'INET',
    classGroupId: 'group_004', classGroup: 'INET-DE-Y4', yearLevel: 4,
  ...
  },
  {
    ...
    facultyId: 'fac_001', departmentId: 'dep_001', programId: 'prog_001',
    program: 'Information and Network Engineering', programCode: 'INET',
    classGroupId: 'group_002', classGroup: 'INET-DE-RB', yearLevel: 3,
  ...
  },
  {
    ...
    faculty: 'คณะเทคโนโลยีและการจัดการอุตสาหกรรม', department: 'ภาควิชาเทคโนโลยีสารสนเทศ', year: 3,
    facultyId: 'faculty_fimt', departmentId: 'department_it', programId: 'program_inet',
    program: 'สาขาวิชาวิศวกรรมสารสนเทศและเครือข่าย', programCode: 'INET',
    classGroupId: 'group_inet_de_ra', classGroup: 'INET-DE-RA', yearLevel: 3,
    faceReferenceUrl: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=200&auto=format&fit=crop&q=80',
  ...
  },
  {
    ...
    facultyId: 'faculty_fimt', departmentId: 'department_it', programId: 'program_inet',
    program: 'สาขาวิชาวิศวกรรมสารสนเทศและเครือข่าย', programCode: 'INET',
    classGroupId: 'group_inet_de_rb', classGroup: 'INET-DE-RB', yearLevel: 3,
  ...
  },
  {
    ...
    faculty: 'คณะเทคโนโลยีและการจัดการอุตสาหกรรม', department: 'ภาควิชาเทคโนโลยีสารสนเทศ', year: 3,
    facultyId: 'faculty_fimt', departmentId: 'department_it', programId: 'program_ine',
    program: 'สาขาวิชาวิศวกรรมสารสนเทศและเครือข่าย', programCode: 'INE',
    classGroupId: 'group_ine_de_ra', classGroup: 'INE-DE-RA', yearLevel: 3,
    faceReferenceUrl: 'https://images.unsplash.com/photo-1539571696357-5a69c17a67c6?w=200&auto=format&fit=crop&q=80',
    faceReferenceStatus: 'available', accountStatus: 'active', isFirstTime: false,
  },
  {
  ...
  },
  {
    ...
    facultyId: 'faculty_fimt', departmentId: 'department_it', programId: 'program_ine',
    program: 'สาขาวิชาวิศวกรรมสารสนเทศและเครือข่าย', programCode: 'INE',
    classGroupId: 'group_ine_de_rb', classGroup: 'INE-DE-RB', yearLevel: 3,
    faceReferenceUrl: '', faceReferenceStatus: 'missing', accountStatus: 'active', isFirstTime: true,
  },
  {
    id: 'std_ine_rb_002',
  ...
  },
  {
    ...
    facultyId: 'faculty_fimt', departmentId: 'department_it', programId: 'program_ine',
    program: 'สาขาวิชาวิศวกรรมสารสนเทศและเครือข่าย', programCode: 'INE',
    classGroupId: 'group_ine_de_rc', classGroup: 'INE-DE-RC', yearLevel: 3,
    faceReferenceUrl: 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=200&auto=format&fit=crop&q=80',
