...
const steps = ['คณะ', 'ภาควิชา', 'สาขาวิชา', 'ปีเข้าและกลุ่มเรียน', 'ตรวจสอบและบันทึก'];
